...
import Utilities.Gesture_Utils;
...
public class LoginTests extends AppiumSessionManager{
	...
	driver = AppiumSessionManager.startAndroidSession(deviceName,udid, platformVersion, automationName, browserName, appPath, appPackage,appActivity,"Android",null,null,null,null,null,null,null);
